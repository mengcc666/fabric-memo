...
VERSION=2.2.8		=> Fabric binary file version
CA_VERSION=1.5.3	=> CA binary file version
...
Then, find the right version from Step.2 (eg. tag 2.2.8) and download ***-linux-***.tar.gz
